...
export class FormComponent implements OnInit {
  ...
  ngAfterViewInit(): void {
    ...
    let text1: string =
      'Выражаем Вам огромную признательность и искренне благодарим за участие в поздравлении открытками пожилых людей и людей с инвалидностью в рамках нашего проекта "Поздравление открытками".';
    let text2: string =
      'Добрые дела не остаются незамеченными – они как маяки светят тем, кто ждёт помощи. Спасибо, что вместе с нами меняете к лучшему жизнь пожилых людей и людей с инвалидностью! Благодаря Вам в жизни одиноких людей становится больше радости и заботы.';
    ...
    img.addEventListener(
      ...
      () => {
        ...
        ctx.fillText('БЛАГОДАРНОСТЬ', 298, 210);
        ctx.font = '15px Arial';
        ...
        ctx.fillText(
          'Пусть и в Вашей жизни будет больше доброты и тепла!',
          298,
          this.paragraphY
        );
