...
export class YoungerComponent implements OnInit {
  ...
  ngAfterViewInit(): void {
    ...
    let text1: string =
      'Искренне благодарим тебя за то, что ты участвуешь в поздравлениях бабушек и дедушек, живущих в домах престарелых. Твоя открытка непременно принесёт им радость, тепло и ощущение праздника.';
    let text2: string =
      'Желаем тебе здоровья, успеха и много улыбок!';
