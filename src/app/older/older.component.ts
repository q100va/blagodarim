...
export class OlderComponent implements OnInit {
  ...
  ngAfterViewInit(): void {
    let img = new Image();
    img.src = 'assets/summer_2026_main.jpg';
    ...
    let text1: string =
      'Примите нашу искреннюю признательность за участие в поздравлении открытками жителей домов престарелых. Благодаря вашей отзывчивости и неравнодушию в их жизни появляется праздничное настроение и ощущение заботы и поддержки.';
    let text2: string =
      'Ваши поздравления радуют одиноких людей и скрашивают их будни. Пусть в вашей жизни всегда будут счастье, радость и успех!';
