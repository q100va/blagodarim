...
export class OlderComponent implements OnInit {
  ...
  ngAfterViewInit(): void {
    ...
    let text1: string =
      'Выражаем вам сердечную благодарность за участие в поздравлении открытками одиноких пожилых людей и инвалидов, проживающих в домах престарелых. Каждый отправленный вами конвертик несет нужные слова и милые картинки, которые согревают душу           и радуют взгляд.';
    let text2: string =
      'Без вашего участия было бы невозможно подарить тысячам одиноких людей частичку радости, добра и заботы. Пусть в вашей жизни все получается, а добро возвращается!';
