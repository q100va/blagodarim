...
export class OlderComponent implements OnInit {
  ...
  ngAfterViewInit(): void {
    ...
    let text1: string =
      'Выражаем вам искреннюю благодарность за участие в поздравлении открытками одиноких пожилых людей и инвалидов, проживающих в домах престарелых. Благодарим вас за внимание, заботу и поддержку, которые вы дарите нашим бабушкам, дедушкам и подопечным помоложе с каждой отправленной открыткой.';
    let text2: string =
      'Добрые дела не остаются незамеченными – они как маяки светят тем, кто ждёт помощи. Желаем  вам успехов, сил и энергии для осуществления всего задуманного!';
